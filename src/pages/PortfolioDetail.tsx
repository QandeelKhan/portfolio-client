...
const PortfolioDetail = (props: any) => {
    const cardClicked = useSelector((state: RootState) => state.events);
        ...
        <>
            {cardClicked ? (
                <div>
                    ...
                    <div
                        className={
                            cardClicked ? "transform-in" : "transform-out"
                        }
                    >
                        ...
                        <div className="main-container">
                            ...
                            <div className="right-content">
                                ...
                                <p>
                                    ...
                                    Sem nulla pharetra diam sit amet nisl. Eget
                                    est lorem ipsum dolor sit. Tincidunt tortor
                                    aliquam nulla facilisi cras fermentum odio
                                    eu. Odio aenean sed adipiscing diam.
                                    Adipiscing tristique risus nec feugiat.
                                    Laoreet suspendisse interdum consectetur
                                    libero. Sem fringilla ut morbi tincidunt
                                    augue interdum velit euismod in. Amet
                                    volutpat consequat mauris nunc congue nisi
                                    vitae suscipit tellus. Elementum facilisis
                                    leo vel fringilla est ullamcorper eget nulla
                                    facilisi. Platea dictumst vestibulum rhoncus
                                    est pellentesque. Aliquet nibh praesent
                                    tristique magna. Senectus et netus et
