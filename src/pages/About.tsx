            ...
            <div className="about-all-info">
                <div className="about-left-info">
                    ...
                    <span className="uiux-dummy-text">
                        ...
                        bachelor's in Computer Science (B.S). from GC University
                        Faisalabad and 4 years of software development
                        experience. I am experienced in web development with
                        JavaScript technologies using React JS and React Native
                        and on the back-end side, I'm using python technologies.
                        I have experience with MVT/MVC (Model View
                        Template/Controller) through Django and DRF (Django rest
                        framework) and have been involved in maintaining
                        versions of source code using git version control. I use
                        a containerized system using Docker/Kubernetes for the
                        ...
                        version of the project clearly. Thanks for going through
                        my profile, looking forward to be working with you.
                        <br />
                        <br />
                    </span>
