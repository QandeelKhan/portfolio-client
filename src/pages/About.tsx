                        ...
                        <div className="about-all-info">
                            <div className="about-left-info">
                                ...
                                <span className="uiux-dummy-text">
                                    ...
                                    experienced in web development with
                                    JavaScript technologies using React JS and
                                    React Native and on the back-end side, I'm
                                    using python technologies. I have experience
                                    with MVT/MVC (Model View
                                    Template/Controller) through Django and DRF
                                    (Django rest framework) and have been
                                    involved in maintaining versions of source
                                    code using git version control. I use a
                                    containerized system using Docker/Kubernetes
                                    for the portability of my web and mobile
                                    projects and deployment. When working on a
                                    new project, I like to speak with my clients
                                    to understand their needs and version of the
                                    project clearly. Thanks for going through my
                                    profile, looking forward to be working with
                                    you.
                                    <br />
                                    <br />
                                </span>
