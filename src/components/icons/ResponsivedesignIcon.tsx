...
const ResponsivedesignIcon = (props: any) => (
    ...
    >
        ...
        <path d="M18.5 18h-4c-.827 0-1.5-.673-1.5-1.5v-8c0-.827.673-1.5 1.5-1.5h4c.827 0 1.5.673 1.5 1.5v8c0 .827-.673 1.5-1.5 1.5zm-4-10a.5.5 0 0 0-.5.5v8a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5v-8a.5.5 0 0 0-.5-.5h-4z" />
        <path d="M16.5 16a.498.498 0 0 1-.5-.5.498.498 0 0 1 .5-.5.498.498 0 0 1 .5.5.498.498 0 0 1-.5.5z" />
    </svg>
);
